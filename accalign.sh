...
for LayerNum in `seq 1 12`; do
    ...
    python $WorkLOC/AccAlign/aer.py ${ref_align} $WorkLOC/AccAlign/infer_output/XX2XX.align.$LayerNum --fAlpha 0.5 $reftype --most_common_errors 30 --source $SRC --target $TGT
done
