...
TRAIN_FILE_SRC=$WorkLOC/AccAlign/ALIGN6/train_data/train.src
TRAIN_FILE_TGT=$WorkLOC/AccAlign/ALIGN6/train_data/train.tgt
TRAIN_FILE_ALIGN=$WorkLOC/AccAlign/ALIGN6/train_data/train.talp

#TRAIN_FILE_SRC=$WorkLOC/xxx/train.src
#TRAIN_FILE_TGT=$WorkLOC/xxx/train.tgt
#TRAIN_FILE_ALIGN=$WorkLOC/xxx/train.talp

EVAL_FILE_SRC=$WorkLOC/AccAlign/ALIGN6/dev_data/dev.src
EVAL_FILE_TGT=$WorkLOC/AccAlign/ALIGN6/dev_data/dev.tgt
Eval_gold_file=$WorkLOC/AccAlign/ALIGN6/dev_data/dev.talp
